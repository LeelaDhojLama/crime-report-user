...
public class CameraFragment extends BaseFragment {
    ...
    protected View onViewReady(View view, Bundle savedInstanceState) {
        mTextureView = view.findViewById(R.id.textureCameraView);
...
//                    createCameraPreview();
                    getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.root,ImageAddFragment.newInstance(file.getPath()),"Image").addToBackStack("Image").commit();
                }
            };
